...
public class AdminController {
	...
	protected void authenticateAdmin(@RequestParam(name = "email") String email,
	...
	protected void logout(HttpSession httpSession, HttpServletResponse httpServletResponse) throws IOException {
